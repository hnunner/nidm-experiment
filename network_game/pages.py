    ...
    def js_vars(self):
        ...
        for player in self.subsession.get_players():
            ...
            if player.id_in_group == 2:
                ties_form_req_options[player.id_in_group] = "3 6 12".split()
            else:
                ties_form_req_options[player.id_in_group] = "1 2 3".split()
            ...
            if player.id_in_group == 2:
                ties_form_res_options[player.id_in_group] = "9".split()
            else:
                ties_form_res_options[player.id_in_group] = "12".split()
            ...
            if player.id_in_group == 2:
                ties_rem_options[player.id_in_group] = "8".split()
            else:
                ties_rem_options[player.id_in_group] = "5".split()
